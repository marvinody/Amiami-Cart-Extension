...
export default function OverwriteCartToggle({
  ...
  return (
    <Switch.Group as="div" className="flex items-center">
      <Switch
        checked={overwriteCart}
        onChange={setOverwriteCart}
        className={classNames(
          overwriteCart ? 'bg-indigo-600' : 'bg-gray-200',
      ...
      >
        <span
          aria-hidden="true"
          className={classNames(
            overwriteCart ? 'translate-x-5' : 'translate-x-0',
      ...
      <Switch.Label as="span" className="ml-3">
        <span className="text-sm font-medium text-gray-900">Overwrite Existing Cart</span>
      </Switch.Label>
    </Switch.Group>
  );
}
